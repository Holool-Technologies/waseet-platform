...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260723214446_Phase_SkillLevelsBadgesStats")]
    partial class Phase_SkillLevelsBadgesStats
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Waseet.Domain.Entities.ClientStats", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<decimal>("AvgPaymentDays")
                    ...
                    b.Property<int>("DisputesWon")
                        .HasColumnType("int");

                    b.Property<int>("TasksCompleted")
                        .HasColumnType("int");

                    b.Property<int>("TasksPosted")
                        .HasColumnType("int");

                    b.Property<int>("TotalPaidUSD")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Waseet.Domain.Entities.FreelancerBadge", b =>
                {
            ...
            modelBuilder.Entity("Waseet.Domain.Entities.FreelancerStats", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("ConsecutiveOnTime")
                        .HasColumnType("int");

                    b.Property<int>("DisputesLost")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("RepeatClientsCount")
                        .HasColumnType("int");

                    b.Property<int>("RevisionsRequested")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("TasksAwarded")
                        .HasColumnType("int");

                    b.Property<int>("TasksCompleted")
                        .HasColumnType("int");

                    b.Property<int>("TotalDisputes")
                        .HasColumnType("int");

                    b.Property<decimal>("TotalEarningsUSD")
                        .HasColumnType("DECIMAL(18,2)");

                    b.Property<int>("UniqueClientsCount")
                        .HasColumnType("int");

                    b.HasKey("UserId");

                    b.ToTable("FreelancerStats");
                });
            ...
            modelBuilder.Entity("Waseet.Domain.Entities.ClientStats", b =>
                {
                    b.HasOne("Domain.Entities.User", "User")
                        .WithOne()
                        .HasForeignKey("Waseet.Domain.Entities.ClientStats", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Waseet.Domain.Entities.FreelancerStats", b =>
                {
                    b.HasOne("Domain.Entities.User", "User")
                        .WithOne()
                        .HasForeignKey("Waseet.Domain.Entities.FreelancerStats", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
