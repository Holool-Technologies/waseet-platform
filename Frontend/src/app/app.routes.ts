...
export const routes: Routes = [
  ...
  {
    path: 'tasks/:code',
    loadComponent: () => import('./features/tasks/detail/task-detail/task-detail.component').then(m => m.TaskDetailComponent),
    canActivate: [authGuard]
  },
  {
    path: 'post-task',
    loadComponent: () => import('./features/tasks/post/post-task/post-task.component').then(m => m.PostTaskComponent),
