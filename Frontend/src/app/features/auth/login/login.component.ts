      ...
      <div class="w-full max-w-md">
        <div class="card p-8">
          ...
          <form [formGroup]="form" (ngSubmit)="submit()" class="space-y-4">
            ...
            <div>
              ...
              <div class="relative">
                <input formControlName="password"
                  ...
                  [class.ring-2]="passwordError()"
                  [class.ring-red-400]="passwordError()" />
            ...
            @if (generalError()) {
              <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-600 dark:text-red-400 text-sm px-4 py-3 rounded-xl">
                {{ generalError() }}
              </div>
            }
